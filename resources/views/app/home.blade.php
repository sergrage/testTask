...
<div class="jumbotron mt-5">
  <h1 class="display-4">Тут главная страница</h1>

  <hr class="my-4">
  <p>6 последних добавленных статей. LIFO.</p>
</div>
<div class="row">
...
<div class="col-md-4">
	<div class="card p-3 m-3">
	  ...
	  <div class="card-body">
	    ...
	    <a href="{{route('article.show', $article->slug)}}" class="btn btn-primary">Открыть статью</a>
	  </div>
	  ...
	  <div class="mt-5">Опубликовано {{ $article->createdAtForHumans()}} </div>
	</div>
</div>
@endforeach
</div>
